    ...
    <form method="POST" action="/listings">
      ...
      <div class="mb-4">
        <select name="job_type" class="w-full px-4 py-2 border rounded focus:outline-none">
          ...
          <option value="full_time" <?= isset($listing['job_type']) && $listing['job_type'] === 'full_time' ? 'selected' : '' ?>>Full-Time</option>
          <option value="part_time" <?= isset($listing['job_type']) && $listing['job_type'] === 'part_time' ? 'selected' : '' ?>>Part-Time</option>
          <option value="internship" <?= isset($listing['job_type']) && $listing['job_type'] === 'internship' ? 'selected' : '' ?>>Internship</option>
        </select>
      </div>
      <div class="mb-4">
